...
resource "payment_gateway/purchases", document: :v1 do
  ...
  let!(:card) { c = create(:card, customer: customer, token: '40C8D8C041590AD9E053321E320A4D52'); customer.cards << c; c }
  ...
  post "/purchases" do
    ...
    include SpecHelpers::VcrDoRequest[:payment_gateway_purchases_normal_card]
